 ...
 * 2022/6/21
 */
public class InternetCelebrityPicActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_internet_celebrity_pic);
        initView();
        initData();
        initEvent();
    }
    ...
    private void initView() {
        ...
        mImageView = findViewById(R.id.iv_internet_celebrity);
    ...
    private void initData() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(Constant.API_INTERNET_CELEBRITY_PIC)
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        InternetCelebrityPicApi celebrityPicApi = retrofit.create(InternetCelebrityPicApi.class);
        Call call = celebrityPicApi.getInternetCelebrityPic();
    ...
    public static void startActivity(Context context) {
        Intent intent = new Intent(context, InternetCelebrityPicActivity.class);
